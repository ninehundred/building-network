...
def main():
    ...
    # TODO: get the level information from the data, and then create the level class out of this (it will have empty rooms and doors)
    
        # 'name'
        #  'parameters'- this is where I can likely get the GUID
        # 'elevation'
        # 'applicationId'- can this be used to reliably tell me this is revit?
        pass

    building_01_obj = Building()

    speckle_data_handler = SpeckleDataHandler(data)
    # TODO: write process levels script
